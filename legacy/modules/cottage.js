...
export function createCottage(THREE, { x = 0, z = 0, facing = 0, env = { night01: 0 } } = {}) {
  ...
  // ---- Walls ----
  const wallMat = new THREE.MeshStandardMaterial({ color: '#e9e1d1', roughness: 0.95, flatShading: true });
